...
/**
 * Provides a suite of test for Search implementations. The test class for your
 * implementation should use this class as a base class. Add additional tests to
 * your test class.
 */
public abstract class SearchTest {

	/**
	 * Creates and returns an implementation of the Search interface. Override this
	 * method in the super class with, for instance, a BinarySearch implementation
	 * 
	 * <pre>
	 &#64;override
